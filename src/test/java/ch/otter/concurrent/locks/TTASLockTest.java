...
class TTASLockTest {
    ...
    void testSingleThreadLocking() {
        LockInterfaceTests.testSimpleLock(new TTASLock(), 1);
    }
    ...
    void testTryLockSimpleFalseSingleBlock() {
        LockInterfaceTests.testTryLockSimpleFalseSingleBlocker(new TTASLock());
    }
    ...
    void testTryLockTimeOutFalseSingleBlocker(){
        LockInterfaceTests.testTryLockTimeOutFalseSingleBlocker(new TTASLock());
    }
}